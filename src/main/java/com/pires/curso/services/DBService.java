...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat7 = new Categoria(null, "Livros e música");
		Categoria cat8 = new Categoria(null, "Viajens");
		...
		Produto p10 = new Produto(null, "Pendrive", 180.00);
		...
		Cliente cli1 = new Cliente(null, "Maria silva", "xxxx@hotmail.com", "363789912377",
				TipoCliente.PESSOAFISICA, pe.encode("1234"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838993"));

		Cliente cli2 = new Cliente(null, "João farias", "xxxx@gmail.com", "31628382740", TipoCliente.PESSOAFISICA,
				pe.encode("1234"));
		cli2.getTelefones().addAll(Arrays.asList("56732498", "61492501"));
		...
		Endereco end3 = new Endereco(null, "Rua rio negro", "22", null, "Centro", "06572000", cli2, cid2);
		...
		Pagamento pgto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("01/02/2015 01:00"),
				null);
